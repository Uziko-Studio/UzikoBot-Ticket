...
module.exports =  async (bot, interation) =>{
    ...
    if (!check){
        ...
        const parent = await bot.channels.fetch(config.tickets.Question)
        ...
        await channel.permissionOverwrites.create(config.roles.support,{
            ViewChannel: true,
            EmbedLinks: true,
            SendMessages: true,
            AttachFiles: true,
        ...
        await channel.permissionOverwrites.create(config.roles.t_support,{
            ViewChannel: true,
            EmbedLinks: true,
            SendMessages: true,
            AttachFiles: true,
        ...
        await open(bot, channel, interation, "questions")
    }else {
